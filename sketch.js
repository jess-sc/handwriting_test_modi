...
new p5(function(p) {
      ...
      if(showDebug){
        ...
        p_vals.push(pressure);

        //p.text("pressure string = " + p_vals, 15, 20);
...
FloatingButton.onClick = download(p_vals, 'dowload.csv', 'text/csv;encoding:utf-8');
/***********************
*       UTILITIES      *
************************/
...
//FloatingButton = download(p_vals, 'dowload.csv', 'text/csv;encoding:utf-8');
